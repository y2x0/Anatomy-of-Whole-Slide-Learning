...
Current public notebook count: **630** markdown files.
...
- `notebooks/mil_aggregation/` (**16 markdown files, foundations and
  mean/attention portions complete**): how latent instances become bag predictions under different
