...
Each prototype has a time-varying risk contribution
```math
r_m(t)
```
.
...
g_\theta
```
create exploding hazards and gradients. Softplus
...
z_i
```
collapses rare morphology, the hazard function cannot use it.
