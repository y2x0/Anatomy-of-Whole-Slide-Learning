...
$S_i^{\mathrm{obs}}$ rather than the object it would ideally supervise. A slide
...
This folder studies $S_i^{\mathrm{obs}}$ and the algorithm-generated targets
derived from it.
...
Different weak-supervision methods are different assumptions about $Q$, about
which parts of $U_i$ can be inferred from $S_i^{\mathrm{obs}}$, and about when
$\widehat U_{i,t}$ is accurate enough to use as extra pressure.
